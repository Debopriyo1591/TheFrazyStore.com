	...
	<div class="collapse navbar-collapse js-navbar-collapse">
		<ul class="nav navbar-nav">
                    ...
                    <?php
                        ...
                        $this->db->where('SystemMenuParentID', 0);
                        $menu_list = $this->db->get();

                        foreach ($menu_list->result() as $menu): ?>
                        <li class="dropdown dropdown-large">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo ucwords($menu->SystemMenuTitle) ?><b class="caret"></b></a>

                            <?php

                                $cat_id = $menu->SystemMenuID;

                                $this->db->from('SystemMenu');
                                $this->db->where('SystemMenuParentID', $cat_id);
                            ...
                            <ul class="dropdown-menu dropdown-menu-large row">
                                <?php foreach ($submenu_list->result() as $submenu): ?>
                                    <li class="col-sm-3" style="width:200px">
                                        <a href=""><?php echo ucwords($submenu->SystemMenuTitle) ?></a>
                                    </li>
                                <?php endforeach; ?>
                            </ul>
                        </li>
