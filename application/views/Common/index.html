...
<header id="header_wrapper">
  <div class="container">
    <div class="header_box">
      <div class="logo"><a href="#"><img src="img/logo_ab.png" alt="logo"></a>
      </div>
      <nav class="navbar navbar-inverse" role="navigation">
          ...
          <div class="shop-menu pull-right">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="cart.html"><i class="fa fa-shopping-cart"></i> List your Space</a></li>
		...
		<ul class="nav navbar-nav">
			<li class="dropdown dropdown-large">
				...
				<ul class="dropdown-menu dropdown-menu-large row">
                                           ...
                                           <li class="col-sm-3" style="width:200px">
                                            <ul>
							<li class="dropdown-header">Clothing</li>
							<li><a href="#">T-shirts & Collared Tees</a></li>
							<li><a href="#">Casual Shirts</a></li>
                                                        ...
                                                        <li><a href="#">Inner & Sleepwear</a></li>
                                            ...
                                            <ul>
                                                        ...
                                                        <li class="dropdown-header">Formal Wear</li>
                                                        <li><a href="#">Formal Shirts</a></li>
                                                        <li><a href="#">Formal Trousers</a></li>
                                                        <li class="dropdown-header">Accessories</li>
                                                        <li><a href="#">Bags & Backpacks</a></li>
                                                        <li><a href="#">Belts, Ties & Cufflinks</a></li>
                                            ...
                                            <li class="col-sm-3" style="width:200px">
                                            <ul>
							<li class="dropdown-header">Shop By Looks</li>
                                                        <li><a href="#">Office</a></li>
                                                        <li><a href="#">Party & Clubbing</a></li>
                                                        <li><a href="#">Festive & Religious</a></li>
                                                        <li><a href="#">Casual</a></li>
                                                        <li><a href="#">All Occasions</a></li>
                                                        <li class="dropdown-header">Featured Stores</li>
                                                        <li><a href="#">The Stadium</a></li>
                                                        <li><a href="#">Wedding Store</a></li>
                                                        <li><a href="#">Winterwear Store</a></li>
				...
				<ul class="dropdown-menu dropdown-menu-large row">
							...
							<li><a href="#">Wedges</a></li>
                                                        ...
                                                        <li><a href="#">Kurtas, Kurtis & Suits</a></li>
                                            ...
                                            <ul>
                                                        ...
                                                        <li class="dropdown-header">Lingerie & Sleepwear</li>
                                                        <li><a href="#">Bra</a></li>
				...
				<ul class="dropdown-menu dropdown-menu-large row">
                                           ...
                                           <li class="col-sm-3" style="width:200px">
                                            <ul>
							<li class="dropdown-header">Boys Apparel</li>
							<li><a href="#">T-shirts & Shirts</a></li>
							<li><a href="#">Jeans, Trousers, Shorts</a></li>
                                                        <li><a href="#">Sweaters, Sweatshirts, Jackets</a></li>
                                                        <li class="dropdown-header">Boys Footwear</li>
							<li><a href="#">Casual Shoes</a></li>
							<li><a href="#">Sports Shoes</a></li>
                                                        <li><a href="#">Sandals & Clogs</a></li>
                                            ...
                                            <ul>
                                                        ...
                                                        <li class="dropdown-header">Girls Apparel</li>
                                                        <li><a href="#">Frocks</a></li>
                                                        <li><a href="#">Tops & T-shirts</a></li>
                                                        <li><a href="#">Bottomwear</a></li>
                                                        <li><a href="#">Sweaters, Sweatshirts, Jackets</a></li>
                                                        <li class="dropdown-header">Girls Footwear</li>
							<li><a href="#">Ballets</a></li>
							<li><a href="#">Sports Shoes</a></li>
                                                        <li><a href="#">Sandals & Clogs</a></li>
                        ...
                        <li class="dropdown dropdown-large" >
				<a href="#" class="dropdown-toggle" data-toggle="dropdown">Malls </a>
                        </li>
                        <li class="dropdown dropdown-large">
				...
				<a href="#" class="dropdown-toggle" data-toggle="dropdown">Events </a>
                        ...
                        <li class="dropdown dropdown-large">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown">Look Good <b class="caret"></b></a>
				
				<ul class="dropdown-menu dropdown-menu-large row">
					<li class="col-sm-3" style="width:200px">
						<ul>
							<li class="dropdown-header">Meet The Stylist</li>
							...
							<li><a href="#">Manish Malhotra</a></li>
                                           ...
                                           <li class="col-sm-3" style="width:200px">
                                            <ul>
							<li class="dropdown-header">Join Discussion</li>
							<li><a href="#">Discussions</a></li>
                                                 ...
                                                 <li class="col-sm-3" style="width:200px">
                                             <ul>
                                                        <li class="dropdown-header">Blog in Forum</li>
							<li><a href="#">Give your inputs</a></li>
   ...
   <div class="input-group">
       <input type="Search" placeholder="Frazy Search..." class="form-control" />
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="top_left_cont zoomIn wow animated"> 
              <h2>This <strong>Valentines Day</strong> Go Frazy</h2>
              <p>Shop at your favorite store for your loves ones <br/>Checkout the Sales going on.</p>
